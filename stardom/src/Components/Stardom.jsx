...
class Prostar extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            //accsing shared props  // ...this its a Spread Operator it use to access the array elements without type the elments reptaly
    ...
    // definig onClick functions :-
    getRandomContact = () => {
        let rand = [...this.props.data]
        let newStar = []
        for (let i = 0; i < 5; i++) {
            let num = Math.floor(Math.random() * 53) + 1; //53 is the maximum value for the random values
             console.log(num) 
